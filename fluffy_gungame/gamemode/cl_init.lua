...
local wepchain_css = {
    'm', 'x', 't', 'b', 'z', 'B', 's', 'u', 'c', 'j', 'j'
}

surface.CreateFont('GunGameFont', { font='HL2MP', size=32 } )
surface.CreateFont('GunGameCSS', { font='csd', size=32 } )

surface.CreateFont('GunGameFontBig', { font='HL2MP', size=72 } )
surface.CreateFont('GunGameCSSBig', { font='csd', size=72 } )
...
function CreateScoringPane()
    ...
    function Frame:CreatePlayer( ply, x )
        ...
        function p:Paint()
            ...
            if GetGlobalString( 'GunGame_Mode' ) == 'css' then ggfont = 'GunGameCSS' end
...
hook.Add('HUDPaint', 'GungameCoolHUD', function()
    ...
    if GetGlobalString( 'GunGame_Mode' ) == 'css' then ggfont = 'GunGameCSSBig' end
